...
namespace Nadasdladany.Migrations
{
    ...
    [Migration("20250721203612_editablehomemessage")]
    partial class editablehomemessage
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Nadasdladany.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Nadasdladany.Models.Representative", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ImageUrl = "/img/mayor-placeholder.png",
                            IsPublished = true,
                            Name = "Varga Tünde",
            ...
            modelBuilder.Entity("Nadasdladany.Models.SiteSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            SettingValue = "Tisztelt Látogató!"
                        },
                        new
                        {
                            SettingKey = "WelcomeMessageParagraph1",
                            SettingValue = "Szeretettel köszöntöm Önt Nádasdladány község hivatalos honlapján! Célunk, hogy ezen a felületen keresztül átfogó képet adjunk településünk mindennapjairól, működéséről, valamint lehetőséget biztosítsunk az egyszerű és gyors tájékozódásra."
                        },
                        new
                        {
                            SettingKey = "WelcomeMessageParagraph2",
                            SettingValue = "Böngésszen híreink között, ismerje meg önkormányzatunk munkáját, intézményeinket és fedezze fel Nádasdladány természeti és épített értékeit. Reméljük, hasznos információkkal szolgálhatunk minden kedves érdeklődő számára."
                        },
                        new
                        {
                            SettingKey = "MayorName",
                            SettingValue = "Varga Tünde"
                        });
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Nadasdladany.Models.ApplicationUser", null)
                        .WithMany()
